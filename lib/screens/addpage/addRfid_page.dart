...
class _AddRfidPageState extends State<AddRfidPage> {
  ...
  List<TransactionsDBData> itemList = [];
  List<TransactionsDBData> temp_itemList = [];
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Flexible(
                                            child: Text(
                                              '${appLocalizations.txt_number_tag} : ${itemList[index].ItemCode}',
                                              maxLines: 3,
                                      ...
                                      Text(
                                          '${appLocalizations.txt_created} : ${DateFormat('dd-MM-yyyy HH:mm').format(itemList[index].created_date!)}',
                                          style:
                                      ...
                                      Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                                        children: [
                                          itemList[index].updated_date != null
                                              ? Text(
                                                  '${appLocalizations.txt_updated} : ${DateFormat('dd-MM-yyyy HH:mm').format(itemList[index].updated_date!)}',
                                                  style: TextStyle(
                                                      color: Colors.white))
                                              : SizedBox.fromSize(),
                                          Text(
